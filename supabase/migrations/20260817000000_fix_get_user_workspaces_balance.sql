-- Migration: Fix get_user_workspaces balance calculation for payments and custom splits
-- Description: Corrects user net balance formula and excludes settlement payments from total workspace expenses
